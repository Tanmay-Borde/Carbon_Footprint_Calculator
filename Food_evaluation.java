...
public class Food_evaluation extends JFrame {
	...
	public Food_evaluation() {
		...
		JCheckBox potatoes = new JCheckBox("Potatoes");
		...
		JCheckBox tofu = new JCheckBox("Tofu");
		...
		JLabel lblSolution = new JLabel("Your Result :");
		...
		JCheckBox vege = new JCheckBox("Vegetables");
		...
		JCheckBox lamb = new JCheckBox("Lamb");
		...
		JCheckBox pork = new JCheckBox("Pork");
